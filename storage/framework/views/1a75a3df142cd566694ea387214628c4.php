...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Panel - Aresha Florist'); ?></title>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <div class="navbar-nav ms-auto d-flex align-items-center">
                    <a class="nav-link" href="<?php echo e(route('admin.settings.store.index')); ?>">
...
<?php /**PATH C:\Users\vita\aresha-florist (2)\aresha-florist\resources\views/layouts/admin.blade.php ENDPATH**/ ?>