<?php $__env->startSection('title', 'Katalog Karangan Bunga'); ?>
        ...
        <form method="GET" action="<?php echo e(route('products.index')); ?>" class="row g-3 align-items-end">
            <div class="col-md-4">
                ...
                <div class="input-group">
                    <input type="text" name="q" value="<?php echo e($filters['q']); ?>" class="form-control" placeholder="Cari karangan bunga...">
