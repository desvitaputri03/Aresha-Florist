            ...
            <div class="col-lg-8 mx-auto text-center">
                <div class="hero-content">
                    ...
                    <div class="d-flex gap-3 justify-content-center flex-wrap">
                        ...
                        <a href="<?php echo e(route('admin.categories.create')); ?>" class="btn-accent-outline">
                ...
                <div class="product-card fade-in-up">
                    <div class="p-4">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                <h5 class="fw-bold mb-1"><?php echo e($category->nama_kategori); ?></h5>
                                <span class="badge bg-primary"><?php echo e($category->products_count); ?> produk</span>
                            </div>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.categories.edit', $category->id)); ?>">
                                        <i class="fas fa-edit me-2"></i>Edit
                                    </a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item text-danger" href="#" onclick="deleteCategory(<?php echo e($category->id); ?>, <?php echo e($category->products_count); ?>)">
                        ...
                        <p class="text-muted mb-3">
                            <?php echo e($category->deskripsi ? Str::limit($category->deskripsi, 80) : 'Tidak ada deskripsi'); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                                ...
                                Dibuat: <?php echo e($category->created_at->format('d M Y')); ?>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <button type="button"
                                        ...
                                        onclick="deleteCategory(<?php echo e($category->id); ?>, <?php echo e($category->products_count); ?>)"
                                        title="Hapus">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\vita\aresha-florist (2)\aresha-florist\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>