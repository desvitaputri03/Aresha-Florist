<?php $__env->startSection('title', 'Karangan Bunga Padang | Aresha Florist'); ?>
...
.hero-background {
    ...
    width: 100%;
    height: 100%;
    background-image: url('<?php echo e(asset('images/are.jpg')); ?>'); /* Changed hero background image to are.jpg */
...
<section id="featured" class="py-5">
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="product-card fade-in-up">
                    <div class="position-relative">
                        ...
                        <?php else: ?>
                            <img src="https://via.placeholder.com/500x500?text=Karangan+Bunga+Aresha"
                                 ...
                                 class="img-fluid">
                        <?php endif; ?>
                        <?php if($product->harga_diskon && $product->harga > 0): ?>
                            <div class="product-badge">
                                -<?php echo e(round((($product->harga - $product->harga_diskon) / $product->harga) * 100)); ?>%
                            </div>
                        <?php elseif($product->harga_diskon && $product->harga == 0): ?>
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-muted mb-3"><?php echo e(Str::limit($product->deskripsi, 80)); ?></p>
                        <div class="d-flex justify-content-between align-items-center">
                            <?php if($product->harga_diskon): ?>
                                <div>
                                    ...
                                    <small class="text-muted text-decoration-line-through d-block">Rp <?php echo e(number_format($product->harga, 0, ',', '.')); ?></small>
                                </div>
                            <?php else: ?>
        ...
        <div class="text-center mt-5">
            <a href="<?php echo e(route('products.index')); ?>" class="btn-accent">
...
<?php echo $__env->make('layouts.store', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\vita\aresha-florist (2)\aresha-florist\resources\views/welcome.blade.php ENDPATH**/ ?>