...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Karangan Bunga Padang | Aresha Florist'); ?></title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-store" id="storeNavbar">
        <div class="container">
            <a class="navbar-brand brand" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('images/aresha.jpg')); ?>" alt="Aresha Florist Logo" style="height: 80px;">
            </a>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="userMenu" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="far fa-user me-1"></i><?php echo e(auth()->user()->name ?? 'Akun'); ?>

                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
                                <?php if(auth()->user()->is_admin): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-gauge-high me-2"></i>Dashboard Admin</a></li>
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <h5 class="mb-3" style="color: var(--accent-color);">
                        <img src="<?php echo e(asset('images/aresha.jpg')); ?>" alt="Aresha Florist Logo" style="height: 60px; margin-right: 10px;">Aresha Florist
                    </h5>
...
<?php /**PATH C:\Users\vita\aresha-florist (2)\aresha-florist\resources\views/layouts/store.blade.php ENDPATH**/ ?>