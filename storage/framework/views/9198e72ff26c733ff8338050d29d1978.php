<?php $__env->startSection('title', 'Tambah Produk Baru - Admin Panel'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="deskripsi" 
                                  name="deskripsi" 
                                  rows="4"><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="harga" 
                                           name="harga" 
                                           value="<?php echo e((int) old('harga')); ?>" 
                                           min="0" 
                                           required>
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="harga_diskon" 
                                           name="harga_diskon" 
                                           value="<?php echo e((int) old('harga_diskon')); ?>" 
                                           min="0">
                                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" 
                                                <?php echo e(old('id_kategori') == $category->id ? 'selected' : ''); ?>>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" id="is_combinable" name="is_combinable" value="1" <?php echo e(old('is_combinable') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e((int) old('combinable_multiplier', 1)); ?>" 
                                   min="1" 
                                   required>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\vita\aresha-florist (2)\aresha-florist\resources\views/admin/products/create.blade.php ENDPATH**/ ?>