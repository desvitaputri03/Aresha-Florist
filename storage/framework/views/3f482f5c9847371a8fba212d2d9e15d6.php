        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6">
                <div class="product-info">
                    <div class="mb-3">
                        <span class="badge bg-primary fs-6"><?php echo e($product->category->name ?? 'Kategori'); ?></span>
                    </div>
                    ...
                    <div class="price-section mb-4">
                        <?php if($product->harga_diskon): ?>
                            <div class="d-flex align-items-center gap-3">
                                <span class="h2 text-primary fw-bold mb-0">Rp<?php echo e(number_format($product->harga_diskon, 0, ',', '.')); ?></span>
                                <span class="h5 text-muted text-decoration-line-through mb-0">Rp<?php echo e(number_format($product->harga, 0, ',', '.')); ?></span>
                                <span class="badge bg-danger fs-6">
                                    -<?php echo e(round((($product->harga - $product->harga_diskon) / $product->harga) * 100)); ?>%
                                </span>
                            </div>
                        <?php else: ?>
                            <span class="h2 text-primary fw-bold">Rp<?php echo e(number_format($product->harga, 0, ',', '.')); ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if($product->deskripsi): ?>
                        <div class="description mb-4">
                            ...
                            <p class="text-muted lh-lg"><?php echo e($product->deskripsi); ?></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="stock-info mb-4">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <?php if($product->stok > 10): ?>
                                <span class="badge bg-success fs-6"><?php echo e($product->stok); ?> tersedia</span>
                            <?php elseif($product->stok > 0): ?>
                                <span class="badge bg-warning fs-6"><?php echo e($product->stok); ?> tersisa</span>
                            <?php else: ?>
                        ...
                        <?php if($product->stok > 0): ?>
                            ...
                            <div class="card mb-4 border-0 shadow-sm">
                                <div class="card-body bg-light rounded">
                                    ...
                                    <div id="combinedOptionsDetails" style="display: none;">
                                        ...
                                        <?php if($product->combined_description): ?>
                                        <div class="alert alert-info border-0 rounded-3 small">
                                            <i class="fas fa-info-circle me-2"></i>
                                            <p class="mb-0"><?php echo e($product->combined_description); ?></p>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex gap-3 mb-3">
                                <div class="input-group" style="width: 120px;">
                                    ...
                                    <input type="number" id="quantity" class="form-control text-center" value="1" min="1" max="<?php echo e($product->stok); ?>">
                                    <button class="btn btn-outline-primary" type="button" onclick="increaseQuantity()">+</button>
                                </div>
                                <form action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST" class="flex-grow-1 d-flex gap-3">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form id="buy-now-form" action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                ...
                <div class="product-card fade-in-up">
                    <div class="position-relative">
                        <?php if($relatedProduct->gambar): ?>
                            <img src="<?php echo e(asset('storage/'.$relatedProduct->gambar)); ?>"
                        ...
                        <?php else: ?>
                            <img src="https://images.unsplash.com/photo-1518895949257-7621c3c786d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                                 ...
                                 class="img-fluid">
                        <?php endif; ?>
                        <?php if($relatedProduct->harga_diskon): ?>
                            <div class="product-badge">
                                -<?php echo e(round((($relatedProduct->harga - $relatedProduct->harga_diskon) / $relatedProduct->harga) * 100)); ?>%
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="p-4">
                        <h5 class="fw-bold mb-2"><?php echo e($relatedProduct->name); ?></h5>
                        <p class="text-muted mb-3"><?php echo e(Str::limit($relatedProduct->deskripsi, 60)); ?></p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <?php if($relatedProduct->harga_diskon): ?>
                                    <span class="h5 text-primary mb-0">Rp<?php echo e(number_format($relatedProduct->harga_diskon,0,',','.')); ?></span>
                                    <small class="text-muted text-decoration-line-through ms-2">Rp<?php echo e(number_format($relatedProduct->harga,0,',','.')); ?></small>
                                <?php else: ?>
                                    <span class="h5 text-primary mb-0">Rp<?php echo e(number_format($relatedProduct->harga,0,',','.')); ?></span>
                                <?php endif; ?>
                            </div>
                            <a href="<?php echo e(route('products.show', $relatedProduct->id)); ?>" class="btn-accent btn-sm">
...
<?php echo $__env->make('layouts.store', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\vita\aresha-florist (2)\aresha-florist\resources\views/products/show.blade.php ENDPATH**/ ?>