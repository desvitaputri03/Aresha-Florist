...
<div class="p-5 mb-5 text-center bg-light rounded-3">
    ...
    <p class="lead">Temukan karangan bunga papan terbaik untuk setiap momen spesialmu.</p>
    <a href="#produk" class="btn btn-lg btn-success mt-3">Lihat Koleksi</a>
</div>

<!-- Kategori -->
<h3 class="mb-4 text-center">Kategori Karangan Bunga</h3>
...
<div class="text-center p-5 bg-success text-white rounded mt-5">
    <h2 class="fw-bold">Pesan Karangan Bunga Sekarang</h2>
    <p>Buat momen spesialmu lebih indah dengan papan bunga ucapan dari kami.</p>
    <a href="#produk" class="btn btn-light btn-lg">Pesan Sekarang</a>
</div>
