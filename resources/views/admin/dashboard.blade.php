            ...
            <div class="col-lg-8 mx-auto text-center">
                <div class="hero-content">
                    ...
                    <div class="d-flex gap-3 justify-content-center flex-wrap">
                        ...
                        <a href="{{ route('admin.products.create') }}" class="btn-accent-outline">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-card fade-in-up">
                    <div class="p-4 text-center">
                        ...
                        <h3 class="fw-bold text-primary mb-2">{{ $totalProducts ?? 0 }}</h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-card fade-in-up">
                    <div class="p-4 text-center">
                        ...
                        <h3 class="fw-bold text-primary mb-2">{{ $totalCategories ?? 0 }}</h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-card fade-in-up">
                    <div class="p-4 text-center">
                        ...
                        <h3 class="fw-bold text-primary mb-2">{{ $totalOrders ?? 0 }}</h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-card fade-in-up">
                    <div class="p-4 text-center">
                        ...
                        <h3 class="fw-bold text-primary mb-2">Rp{{ number_format($totalRevenue ?? 0, 0, ',', '.') }}</h3>
...
<section class="py-5 bg-light">
    <div class="container">
                ...
                <div class="product-card fade-in-up">
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.products.edit', $product->id) }}" class="btn-accent btn-sm">
        ...
        <div class="text-center mt-5">
            <a href="{{ route('admin.products.index') }}" class="btn-accent">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-card fade-in-up text-center">
                    <div class="p-4">
                        ...
                        <a href="{{ route('admin.orders.index') }}" class="btn-accent">
