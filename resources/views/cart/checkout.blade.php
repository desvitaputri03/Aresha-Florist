            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="mb-5 text-center">
                        <h1 class="display-6 fw-bold mb-2" style="font-family: 'Playfair Display', serif;">Selesaikan
                            Pesanan</h1>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-7">
                                <div class="card border-0 shadow-sm p-4 h-100">
                                    ...
                                    <div class="mb-3">
                                        <label for="nama" class="form-label small fw-bold">Nama Lengkap <span
                                                class="text-danger">*</span></label>
                                        <input type="text"
                                            class="form-control form-control-lg fs-6 @error('nama') is-invalid @enderror"
                                            id="nama" name="nama" value="{{ old('nama', auth()->user()->name) }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="telepon" class="form-label small fw-bold">No. WhatsApp/Telepon <span
                                                class="text-danger">*</span></label>
                                        <input type="text"
                                            class="form-control form-control-lg fs-6 @error('telepon') is-invalid @enderror"
                                            id="telepon" name="telepon" value="{{ old('telepon', auth()->user()->phone) }}"
                                            required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="email" class="form-label small fw-bold">Email <span
                                                class="text-danger">*</span></label>
                                        <input type="email"
                                            class="form-control form-control-lg fs-6 @error('email') is-invalid @enderror"
                                            id="email" name="email" value="{{ old('email', auth()->user()->email) }}"
                                            required>
                                        <div class="form-text extra-small">Email untuk konfirmasi pesanan</div>
                                    </div>


                                    <div class="mb-3">
                                        <label for="alamat" class="form-label small fw-bold">Alamat Lengkap di Padang <span
                                                class="text-danger">*</span></label>
                                        <textarea class="form-control fs-6 @error('alamat') is-invalid @enderror"
                                    ...
                                    <div class="mb-3">
                                        <label for="delivery_date" class="form-label small fw-bold">Tanggal Pengiriman <span
                                                class="text-danger">*</span></label>
                                        <input type="date"
                                            class="form-control form-control-lg fs-6 @error('delivery_date') is-invalid @enderror"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="recipient_name" class="form-label small fw-bold">Nama Penerima <span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control fs-6 @error('recipient_name') is-invalid @enderror"
                                                id="recipient_name" name="recipient_name"
                                                value="{{ old('recipient_name') }}" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="event_type" class="form-label small fw-bold">Jenis Acara <span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control fs-6 @error('event_type') is-invalid @enderror"
                                                id="event_type" name="event_type" value="{{ old('event_type') }}" required>
                                        </div>
                                    </div>

                                    <div class="mb-0">
                                        <label for="custom_message" class="form-label small fw-bold">Isi Pesan / Ucapan
                                            <span class="text-danger">*</span></label>
                                        <textarea class="form-control fs-6 @error('custom_message') is-invalid @enderror"
                                            id="custom_message" name="custom_message" rows="3" required></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="card border-0 shadow-sm p-4 mb-4">
                                    ...
                                    <div class="d-flex justify-content-between py-3 border-top">
                                        ...
                                        <span class="h4 fw-bold mb-0"
                                            style="color: var(--accent-pink);">Rp{{ number_format($total, 0, ',', '.') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="card border-0 shadow-sm p-4">
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary w-100 py-3 mt-4 border-radius-sm fw-bold ls-wide"
